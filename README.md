# vscode-libaacs-keydb

This is the source code repository for the `libaacs-keydb`
VS Code extension.
...
vscode-libaacs-keydb depends only indirectly, e.g. through a
...
all the way down to vscode-libaacs-keydb), the patch may be
